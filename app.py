...
MAX_AMOUNT = 10000000  # 1 crore max
    ...
    try:
        with app.app_context():
            ...
            if not demo_user:
                ...
                db.session.commit()
                demo_transactions = [
                    {"description": "Monthly Salary", "amount": 50000.0, "type": "income", "category": "Salary", "date": "2025-09-01"},
                    {"description": "Grocery Shopping", "amount": 2500.0, "type": "expense", "category": "Food", "date": "2025-09-02"},
                    {"description": "Electricity Bill", "amount": 1200.0, "type": "expense", "category": "Utilities", "date": "2025-09-01"},
                    {"description": "Coffee Shop", "amount": 350.0, "type": "expense", "category": "Food", "date": "2025-09-02"},
                    {"description": "Freelance Project", "amount": 15000.0, "type": "income", "category": "Freelance", "date": "2025-08-30"}
                ]
        ...
        if request.method == "POST":
            ...
            try:
                ...
                if amount > MAX_AMOUNT:
                    return jsonify({"error": f"Amount cannot exceed ₹{MAX_AMOUNT:,.0f}"}), 400
